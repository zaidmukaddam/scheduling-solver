  ...
  return (
    <div>
      <Head>
        ...
        />
        <meta property="og:title" content="CPU Scheduling Solver" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://scheduling-solver.zaidmkz.xyz"
        />
        <meta name="twitter:title" content="CPU Scheduling Solver" />
        <meta
      ...
      <Footer className="container">
        <a
          href="https://github.com/zaidmukaddam/scheduling-solver"
          target="_blank"
